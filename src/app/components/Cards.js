...
const cardData = [
    { title: 'MO', linkTo: '/voting-in-missouri' },
    { title: 'KS', linkTo: '/voting-in-kansas' },
    { title: 'TX', linkTo: '/voting-in-texas' }
];
        ...
        <aside className={styles.cardsWrapper}>
            <div className={styles.cardsContainer}>
                {cardData.map((card, index) => (
                    <Link className={styles.card} key={index} href={card.linkTo}>
